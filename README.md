...
🔁 How It Works: The Encoder-Decoder Framework
...
![image](https://github.com/user-attachments/assets/f938db5e-8149-4c0e-894e-4a407758ee94)
...
![image](https://github.com/user-attachments/assets/bd0af1c5-ebb2-4bba-8d3d-2c80761f00f2)
...
# Step-1 : Caption Text Preprocessing -
...
# Step-2 : Tokeniztion and Encoded Representation -
...
🧠 Modelling
In the caption generation model, I combine image features with text inputs to produce meaningful descriptions using an LSTM-based architecture.
...
Top-k Sampling / Top-p Sampling: Adds randomness to generate varied captions (used in more creative tasks).
